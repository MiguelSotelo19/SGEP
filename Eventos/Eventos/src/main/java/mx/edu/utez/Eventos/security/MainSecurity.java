package mx.edu.utez.Eventos.security;


import mx.edu.utez.Eventos.security.jwt.JwtAuthenticationFilter;
import mx.edu.utez.Eventos.security.service.UserDetailsServiceImpl;
        ...
        http.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST).permitAll()
                                ...
                                .requestMatchers("/api/categoria/save").hasAnyAuthority("Admin")
                                .requestMatchers("/api/categoria/update/**").hasAnyAuthority("Admin")
                                .requestMatchers("/api/categoria/status/**").hasAnyAuthority("Admin")
                                .requestMatchers("api/talleres/").hasAnyAuthority("Admin", "Participante")
                                .requestMatchers("api/talleres/one/**").hasAnyAuthority("Admin", "Participante")
                                .requestMatchers("api/talleres/save").hasAnyAuthority("Admin")
